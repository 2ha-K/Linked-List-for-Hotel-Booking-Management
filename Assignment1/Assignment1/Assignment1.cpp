...
int main()
{
    ...
    char input1 = 'Z';
    string inputInfo;
    string hotelName, arrivalDate, oldArrivalDate, newArrivalDate, oldHotelName, newHotelName;
    int confirmNum;
    string line;
    bool success = false;
...
// matches one of the case statement
        ...
        case 'A':   //Add the hotel booking info.
            ...
            cout << "\nEnter hotel name: ";
            //----
            getline(cin, hotelName);//getline for string
            ...
            success = list1->addBooking(hotelName, arrivalDate, confirmNum);//addbooking

            
            if (success == true)//condition of success or not
        ...
        case 'C':  //Cancel one HotelBooking
            ...
            success = list1->cancelOneBooking(hotelName, arrivalDate, confirmNum);//cancel one booking
        ...
        case 'D':   //Display all bookings
            //----
            list1->displayAllBookings();//display all
            break;
        ...
        case 'E':   //Display all bookings with a specific hotel
            ...
            //----
            getline(cin, hotelName);
            list1->displayBookingsByHotel(hotelName);//display booking by hotel
            break;
        ...
        case 'F':   //Display all bookings by arrival date
            ...
            //----
            getline(cin, arrivalDate);
            list1->displayBookingsByDate(arrivalDate);//display bookings by date
            break;
        ...
        case 'O':  //Cancel all bookings by a specific hotel
            ...
            //----
            getline(cin, hotelName);
            success = list1->cancelAllBookingsByHotel(hotelName);//cancel all bookings by hotel
        ...
        case 'R':  //Cancel all bookings by a specific arrival date
            ...
            //----
            getline(cin, arrivalDate);
            success = list1->cancelAllBookingsByDate(arrivalDate);//cancel all bookings by date
            if (success)
        ...
        case 'S':  //search a specific booking
            ...
            cin >> confirmNum;
            cin.ignore(20, '\n'); //flush the buffer
            success = list1->searchBooking(hotelName, arrivalDate, confirmNum);//search the booking
        ...
        case 'U':  //Delay a booking, i.e. update a booking arrival date
            ...
            //----
            //----
            success = list1->delayABooking(hotelName, oldArrivalDate, confirmNum, newArrivalDate);//change the day of booking not only delay
        ...
        case 'V':  //Change a hotel
            ...
            //----
            //----
            success = list1->changeAHotel(oldHotelName, arrivalDate, confirmNum, newHotelName);//change the hotel
